...
class PurchaseLine(models.Model):
    _name = 'bs.purchase.order.line'
    _rec_name = 'book_id'

    order_id = fields.Many2one('bs.purchase.order', ondelete='cascade')
    ...
    def _onchange_book(self):
        self.unit_price = self.book_id.purchase_cost if self.book_id else 0
